      ...
      <div className="flex w-full items-center">
        <div className="left w-[30%] flex flex-col ml-[100px]">
          <div className="flex items-center space-x-2">
            <img className="w-[50px]" src={logo2} alt="Logo" />
            <span className="text-2xl font-bold text-gray-800">AzanDocs</span>
          </div>
          <form onSubmit={createUser} className="pl-3 mt-5">
            {/* Username Input */}
            ...
            <div className="inputCon">
              ...
              <div className="inputBox w-[100%]">
                <i><img src={nameTag} alt="Name Tag" /></i>
        ...
        <div className="right flex items-end justify-end">
          <img className="h-full" src={rightIMG} alt="Sign Up Illustration" />
        </div>
      </div>
    </div>
  );
...
//         <div className="flex w-full items-center">
//           <div className="left w-[30%] flex flex-col ml-[100px]">
//             <img className='w-[210px]' src={logo2} alt="" />
